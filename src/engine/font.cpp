...
void Font::load_fonts(std::vector<Font *> &fonts) {
    ...
    // SMALL_FONT = 1
    fonts.push_back(new Font("fonts/small.bmp", 6, 7, 4, {
        { ' ', 3 }, { '!', 2 }, { '#', 6 }, { '%', 5 },
        { '&', 5 }, { '\'', 3 }, { '*', 6 }, { ',', 3 },
        { '.', 2 }, { ':', 2 }, { ';', 3 }, { '<', 6 },
        { '>', 6 }, { '@', 5 }, { 'M', 6 }, { 'N', 5 },
    ...
    // SM_BOLD_FONT = 2
    fonts.push_back(new Font("fonts/small_bold.bmp", 6, 7, 5, {
        { ' ', 3 }, { '!', 2 }, { '"', 4 }, { '#', 6 },
        { '$', 4 }, { '\'', 3 }, { '(', 4 }, { ')', 4 },
        { '*', 6 }, { '+', 4 }, { ',', 3 }, { '.', 2 },
        { ':', 2 }, { ';', 3 }, { '<', 6 }, { '>', 6 },
    ...
    // DEFAULT_FONT = 3
    fonts.push_back(new Font("fonts/default.bmp", 6, 10, 5, {
        { ' ', 3 }, { '!', 2 }, { '"', 4 }, { '#', 6 },
        { '\'', 3 }, { '(', 4 }, { ')', 4 }, { '*', 4 },
        { '+', 6 }, { ',', 3 }, { '.', 2 }, { '1', 4 },
        { ':', 2 }, { ';', 3 }, { 'I', 4 }, { 'J', 4 },
    ...
    // BOLD_FONT = 4
    fonts.push_back(new Font("fonts/bold.bmp", 7, 10, 6, {
        { ' ', 4 }, { '!', 2 }, { '"', 4 }, { '$', 5 },
        { '%', 5 }, { '&', 5 }, { '\'', 3 }, { '(', 4 },
        { ')', 4 }, { '*', 4 }, { ',', 3 }, { '.', 2 },
        { '/', 5 }, { '1', 5 }, { ':', 2 }, { ';', 3 },
