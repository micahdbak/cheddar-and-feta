...
public:
    ...
    std::shared_ptr<bool> get_deleted_ptr() {
        return this->deleted_ptr;
    }

    int id;

private:
    // as this is a shared_ptr, it will persist after the object is deleted, assuming something else has an instance of it
    // from Object::get_deleted_ptr. CHECK AGAINST IT IF YOU ARE USING A POINTER TO AN OBJECT.
